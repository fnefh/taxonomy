...
`yaml
version: 2
task\_description: 'Teach the model how to rhyme.'
created\_by: juliadenham
seed\_examples:
...
created\_by: mairin # Use your GitHub username; only one creator supported
seed\_examples:
...
apparent magnitude of 5.7, and has a planet ([HD 142b](HD_142_b "wikilink")) 1.36 times the mass of Jupiter which orbits every 328 days.
...
b](HD_2039_b "wikilink")) six times the mass of Jupiter. [WASP-18](WASP-18 "wikilink") is a star of magnitude 9.29 which was discovered to have a hot
...
diameter, it is an outlying member of the [Sculptor Group](Sculptor_Group "wikilink"). NGC 625 is thought to have been involved in a collision and
is experiencing a burst of [active star formation](Active_galactic_nucleus "wikilink"). [NGC 37](NGC_37 "wikilink") is a
...
[intermediate-mass black hole](intermediate-mass_black_hole "wikilink")—the first one of its kind identified. It is thought to be a
...
document:
repo: https://github.com/juliadenham/Summit\_knowledge
commit: 0a1f2672b9b90582e6115333e3ed62fd628f1c0f
patterns:
- phoenix\_constellation.md
